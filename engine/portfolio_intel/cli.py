...
def build_parser() -> argparse.ArgumentParser:
    ...
    discover = sub.add_parser("discover", help="Rank the S&P 500 for further research")
    discover.add_argument("--limit", type=int, default=20)
    discover.add_argument("--universe", help="Comma-separated ticker symbols; defaults to the current S&P 500")
